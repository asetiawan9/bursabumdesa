    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-2">
                <h3 class="content-header-title mb-0">Staff Detail</h3>
            </div>
        </div>
                                ...
                                <div class="card-block card-dashboard table-responsive">
                                    <form class="form-horizontal" method="post">
										...
										<div class="form-group col-sm-12">
                                            ...
                                            <div class="col-sm-10"><?php echo $general->roleName($role); ?></div>
                                        </div>
										<div class="form-group col-sm-12">
										...
										<div class="form-group col-sm-12">
                                            ...
                                            <div class="col-sm-10"><?php echo $mobile; ?></div>
                                        </div>
										<div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label">Last used IP :</label>
                                            <div class="col-sm-10"><?php echo $recent_ipaddr; ?></div>
                                        </div>
										<div class="form-group col-sm-12">
                                            <label class="col-sm-2 control-label">Last used Browser :</label>
                                            <div class="col-sm-10"><?php echo $user->browserName($recent_browser); ?></div>
                                        </div>
										<div class="form-group col-sm-12">
										...
										<div class="form-actions col-sm-12">
											<a href="<?php echo $baseUrl."staff/$id/"; ?>" class="btn btn-primary mr-1"><i class="fa fa-check-square-o"></i> Edit</a>
