...
function prjt_img1() {
	...
	$("#showimg1").html("<img src='<?=$baseUrl;?>/images/load.gif' height='100px;' width='100px;' alt='loading' />");
...
function prjt_img2() {
	...
	$("#showimg2").html("<img src='<?=$baseUrl;?>/images/load.gif' height='100px;' width='100px;' alt='loading' />");
...
function prjt_img3() {
	...
	$("#showimg3").html("<img src='<?=$baseUrl;?>/images/load.gif' height='100px;' width='100px;' alt='loading' />");
...
function prjt_img4() {
	...
	$("#showimg4").html("<img src='<?=$baseUrl;?>/images/load.gif' height='100px;' width='100px;' alt='loading' />");
...
function video_upload() {
	...
	$("#showvdo").html("<img src='<?=$baseUrl;?>/images/load.gif' height='100px;' width='100px;' alt='loading' />");
