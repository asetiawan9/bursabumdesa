	...
	if(!$captcha){
		...
		if(intval($responseKeys["success"]) !== 1) {
			...
			if($exist_email==0)
			{
				...
				$db->query("insert into register set firstname=:fname,email=:email,password=:password,repassword=:repassword,phone=:phone,user_type='0',tmp_key='$activationkey',active_status='1',reg_ip_addr='$ip_addr',crcdt='$crcdt'");
                ...
                <div class="row">
				  ...
				  <div class="col-sm-6  new_row white_bg">
                     <div class="input-comment">
                            <h4 class="border-title-h4">Register</h4>
						</div>
