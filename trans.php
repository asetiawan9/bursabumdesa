         ...
         <div class="row">
            <div class="col-sm-12">
               <div class="col-sm-12 dashboard">
                  <div class="row">
					<h2 class="mb15i">User Transactions</h2>
                  </div>
				  <div class="row">
                     <div class="col-sm-12">
					   <div class="row ">
							<div class="col-sm-12">
								...
								<table id="example"  class="table table-striped dash_table" style="width:100%;border:1px solid #dadada;">
									...
									<tbody>
				<?php				
					$db->query("select c.id from contribute c inner join project p on p.userid='$userlog' and p.id=c.prjt_id and c.pay_status='1'");
					$cntDets = $db->fetchAll();
